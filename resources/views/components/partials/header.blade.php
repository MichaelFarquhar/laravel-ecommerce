            ...
            <div class="flex flex-wrap justify-between items-center mx-auto">
                ...
                <div class="flex md:order-2">
                    <button type="button"
                        ...
                        class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-center text-white rounded-lg">
                        ...
                        <span
                            class="inline-flex items-center justify-center w-4 h-4 ml-2 text-xs font-semibold text-white bg-red-400 rounded-full lh-0">
                            1
                        </span>
                    </button>
